...
const orderCreated = (date: string | null, status: boolean) => {
    return {
        ...
        icon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <path d="M15 4H6V20H18V7H15V4ZM6 2H16L20 6V20C20 20.5304 19.7893 21.0391 19.4142 21.4142C19.0391 21.7893 18.5304 22 18 22H6C5.46957 22 4.96086 21.7893 4.58579 21.4142C4.21071 21.0393 4 20.5304 4 20V4C4 3.46957 4.21071 2.96086 4.58579 2.58579C4.96086 2.21071 5.46957 2 6 2ZM8 11H16V13H8V11ZM8 15H16V17H8V15Z" />
            </svg>`,
    };
};
...
function buildHistories() {
    ...
    // Helper for estimate
    const estimateText = `Estimated ${dayShippingEstimate.value} days`;
        ...
        if (shippingSlug === "courier") {
            if (status === "pending") {
                return [
                    ...
                    paymentReceived("Soon", false),
                    orderShipped("Soon", false),
            ...
            if (status === "pending") {
                return [
                    ...
                    paymentReceived("Soon", false),
                    orderPickedUp("Pick up at store", false),
                    orderDelivered("When item is picked up", false),
                ];
            }
            if (status === "paid") {
                return [
        ...
        if (shippingSlug === "courier") {
            ...
            if (status === "pending") {
                return [
                    ...
                    orderPickedUp("Pick up at store", false),
                    paymentReceived("When item is picked up", false),
                    orderDelivered("When item is picked up", false),
                ];
            }
            if (status === "paid") {
...
function confirmWhatsApp() {
    ...
    const message = `Hello, I want to confirm my order with transaction code ${props.transaction?.code}.`;
    ...
    <div class="flex flex-col gap-4">
        ...
        >
            ...
            <div class="relative w-full h-1.5 bg-gray-200 rounded-full">
                <div
                    class="absolute top-0 left-0 h-full transition-all ease-out rounded-full bg-primary duration-1000"
                    :style="{
            ...
            <template #content>
                <div class="flex items-center justify-between w-full gap-2">
                    <p>
                        ...
                        Confirm your order via WhatsApp for more information.
                    </p>
                    <PrimaryButton
