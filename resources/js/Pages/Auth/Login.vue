...
<template>
    ...
    <AuthenticationCard class="pt-0!" containerClass="max-w-sm!">
        <LandingHeader
            :invertColor="true"
        ...
        <template #logo>
            ...
            >
                <h1 class="text-2xl font-bold text-gray-800 sm:block">Login</h1>
            </div>
        </template>

        <div
            v-if="$page.props.flash.success"
            class="mb-4 text-sm font-medium text-center text-green-600 px-4 py-3 border border-green-300 rounded-lg bg-green-50"
        >
        ...
        <div
            ...
            class="mb-4 text-sm font-medium text-center text-red-600 px-4 py-3 border border-red-300 rounded-lg bg-red-50"
        >
            {{ form.errors.access }}
        </div>
        ...
        <form @submit.prevent="submit">
            <div>
                <TextInput
                    ...
                    textClass="focus:border-secondary-light focus:ring-secondary-light"
                    required
                    :autofocus="true"
                ...
                >
                    <template #prefix>
                        <svg
                            ...
                            height="25"
                            viewBox="0 0 24 25"
                            class="absolute fill-secondary left-2 size-5"
                        >
                            <path
