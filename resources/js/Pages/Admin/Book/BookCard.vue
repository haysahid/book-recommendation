...
<template>
    ...
    >
        ...
        <div
            ...
            class="absolute top-2 left-2 z-10 inline-flex items-center gap-1 bg-primary text-white border-0 rounded-full shadow-md px-3 py-1 text-sm"
        >
            <svg
        ...
        <div class="flex flex-col items-center w-full gap-4">
            <div class="relative w-full">
                ...
                <div
                    ...
                    class="absolute top-0 bottom-0 py-2 px-3 opacity-0 group-hover:opacity-100 right-0 left-0 flex items-center justify-center bg-black/30 rounded-lg group-hover:scale-105 transition-all duration-300 ease-in-out"
                >
                    <AdminItemAction
                        :hideEditButton="
                            props.hideEditButton || !hasEditCallback
                        "
                        :hideDeleteButton="
                            props.hideDeleteButton || !hasDeleteCallback
                        "
                        @edit="emit('edit')"
                        @delete="emit('delete')"
                        class="bg-white/90 backdrop-blur-sm rounded-full py-2 px-3 shadow-md"
                    />
                </div>
            </div>
        ...
        <div
            v-if="book.score"
            class="absolute top-2 right-2 inline-flex items-center gap-1 bg-white/90 text-foreground border border-border rounded-full shadow-md px-3 py-1 text-sm"
        >
            <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
