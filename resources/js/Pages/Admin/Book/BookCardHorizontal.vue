...
<template>
    <div
        class="flex flex-row items-center justify-between gap-4 p-4 transition-all duration-300 ease-in-out border border-gray-200 rounded-lg hover:border-primary-light hover:ring-1 hover:ring-primary-light relative group hover:shadow-lg cursor-pointer hover:-translate-y-2 bg-white"
    >
        <div class="flex flex-row items-center w-[200px] gap-4">
            <img
        ...
        <div class="flex flex-col items-start justify-start w-full gap-2">
            <div class="flex gap-2 items-center">
                ...
                <div
                    ...
                    class="inline-flex items-center gap-1 bg-primary text-white border-0 rounded-full shadow-none px-3 py-1 text-sm"
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                ...
                <div
                    v-if="book.score"
                    class="inline-flex items-center gap-1 bg-white/90 text-foreground border border-border rounded-full shadow-none px-3 py-1 text-sm"
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
            ...
            >
                <div v-if="props.book.author" class="flex items-center gap-0.5">
